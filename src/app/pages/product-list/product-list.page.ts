...
import { GetProductsList, ProductCat, getProductsListWithPage } from 'src/app/interfaces/products.interfaces';
...
@Component({
  ...
  standalone: true,
  imports: [IonicModule, CommonModule, FormsModule, ComponentsModule, HttpClientModule]
})
